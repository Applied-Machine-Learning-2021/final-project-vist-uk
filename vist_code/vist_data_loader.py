...
def get_loader(vocab, image_features, image_names, v_sent, transform, batch_size, shuffle, num_workers): # maybe add transform, pkl_dir, vocab
    ...
    data_loader = torch.utils.data.DataLoader(dataset=vist, batch_size=batch_size, num_workers=num_workers,collate_fn=collate_fn,shuffle=shuffle) # default collate_fn
    return data_loader
